...
**fields_v1** | **object** | FieldsV1 holds the first JSON version format as described in the \&quot;FieldsV1\&quot; type. +optional | [optional] 
**manager** | **str** | Manager is an identifier of the workflow managing these fields. | [optional] 
**operation** | [**V1ManagedFieldsOperationType**](V1ManagedFieldsOperationType.md) | Operation is the type of operation which lead to this ManagedFieldsEntry being created. The only valid values for this field are &#39;Apply&#39; and &#39;Update&#39;. | [optional] 
