...
[**edge_group_update**](EdgeGroupsApi.md#edge_group_update) | **PUT** /edge_groups/{id} | Updates an EdgeGroup
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.EdgeGroupsApi(api_client)
    body = openapi_client.EdgegroupsEdgeGroupCreatePayload() # EdgegroupsEdgeGroupCreatePayload | EdgeGroup data

    try:
        # Create an EdgeGroup
        api_response = api_instance.edge_group_create(body)
        print("The response of EdgeGroupsApi->edge_group_create:\n")
        pprint(api_response)
...
|-------------|-------------|------------------|
**204** | No Content |  -  |
**409** | Edge group is in use by an Edge stack or Edge job |  -  |
**500** | Server error |  -  |
**503** | Edge compute features are disabled |  -  |
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EdgeGroupsApi->edge_group_inspect:\n")
        pprint(api_response)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EdgeGroupsApi->edge_group_list:\n")
        pprint(api_response)
    except Exception as e:
...
# **edge_group_update**
> PortainerEdgeGroup edge_group_update(id, body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.EdgeGroupsApi(api_client)
    id = 56 # int | EdgeGroup Id
    body = openapi_client.EdgegroupsEdgeGroupUpdatePayload() # EdgegroupsEdgeGroupUpdatePayload | EdgeGroup data

    try:
        # Updates an EdgeGroup
        api_response = api_instance.edge_group_update(id, body)
        print("The response of EdgeGroupsApi->edge_group_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EdgeGroupsApi->edge_group_update: %s\n" % e)
```
