...
**items** | [**List[V1beta1PodMetrics]**](V1beta1PodMetrics.md) | List of pod metrics. | [optional] 
...
v1beta1_pod_metrics_list_instance = V1beta1PodMetricsList.from_json(json)
# print the JSON string representation of the object
print(V1beta1PodMetricsList.to_json())

# convert the object into a dict
v1beta1_pod_metrics_list_dict = v1beta1_pod_metrics_list_instance.to_dict()
# create an instance of V1beta1PodMetricsList from a dict
v1beta1_pod_metrics_list_from_dict = V1beta1PodMetricsList.from_dict(v1beta1_pod_metrics_list_dict)
```
