...
class TestTeammembershipsTeamMembershipUpdatePayload(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TeammembershipsTeamMembershipUpdatePayload:
        """Test TeammembershipsTeamMembershipUpdatePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeammembershipsTeamMembershipUpdatePayload`
        """
        model = TeammembershipsTeamMembershipUpdatePayload()
        if include_optional:
            return TeammembershipsTeamMembershipUpdatePayload(
                role = 1,
                team_id = 1,
                user_id = 1
            )
