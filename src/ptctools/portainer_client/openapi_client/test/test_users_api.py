...
class TestUsersApi(unittest.TestCase):
    ...
    def test_current_user_inspect(self) -> None:
        """Test case for current_user_inspect

        Inspect the current user user
        """
        pass

    def test_user_admin_check(self) -> None:
    ...
    def test_user_admin_init(self) -> None:
    ...
    def test_user_generate_api_key(self) -> None:
    ...
    def test_user_get_api_keys(self) -> None:
    ...
    def test_user_inspect(self) -> None:
    ...
    def test_user_memberships_inspect(self) -> None:
    ...
    def test_user_remove_api_key(self) -> None:
