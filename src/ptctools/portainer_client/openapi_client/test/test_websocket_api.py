...
class TestWebsocketApi(unittest.TestCase):
    ...
    def test_websocket_attach_get(self) -> None:
    ...
    def test_websocket_exec_get(self) -> None:
    ...
    def test_websocket_kubernetes_shell_get(self) -> None:
    ...
    def test_websocket_pod_get(self) -> None:
