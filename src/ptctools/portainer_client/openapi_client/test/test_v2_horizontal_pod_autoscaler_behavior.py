    ...
    def make_instance(self, include_optional) -> V2HorizontalPodAutoscalerBehavior:
        ...
        if include_optional:
            return V2HorizontalPodAutoscalerBehavior(
                scale_down = openapi_client.models.v2/hpa_scaling_rules.v2.HPAScalingRules(
                    policies = [
                        openapi_client.models.v2/hpa_scaling_policy.v2.HPAScalingPolicy(
                            period_seconds = 56, 
                            type = openapi_client.models.type.type(), 
                            value = 56, )
                        ], 
                    select_policy = openapi_client.models.select_policy.selectPolicy(), 
                    stabilization_window_seconds = 56, 
                    tolerance = openapi_client.models.tolerance.tolerance(), ),
                scale_up = openapi_client.models.v2/hpa_scaling_rules.v2.HPAScalingRules(
                    policies = [
                        openapi_client.models.v2/hpa_scaling_policy.v2.HPAScalingPolicy(
                            period_seconds = 56, 
                            type = openapi_client.models.type.type(), 
