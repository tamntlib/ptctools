    ...
    def make_instance(self, include_optional) -> V1ResourceQuotaSpec:
        ...
        if include_optional:
            return V1ResourceQuotaSpec(
                ...
                scope_selector = openapi_client.models.v1/scope_selector.v1.ScopeSelector(
                    match_expressions = [
                        openapi_client.models.v1/scoped_resource_selector_requirement.v1.ScopedResourceSelectorRequirement(
                            operator = openapi_client.models.operator.operator(), 
                            scope_name = openapi_client.models.scope_name.scopeName(), 
                            values = [
                                ''
                                ], )
                        ], ),
