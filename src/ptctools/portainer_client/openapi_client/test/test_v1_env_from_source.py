    ...
    def make_instance(self, include_optional) -> V1EnvFromSource:
        ...
        if include_optional:
            return V1EnvFromSource(
                config_map_ref = openapi_client.models.v1/config_map_env_source.v1.ConfigMapEnvSource(
                    name = '', 
                    optional = True, ),
                prefix = '',
                secret_ref = openapi_client.models.v1/secret_env_source.v1.SecretEnvSource(
                    name = '', 
                    optional = True, )
            )
        else:
