    ...
    def make_instance(self, include_optional) -> V2HorizontalPodAutoscalerSpec:
        ...
        if include_optional:
            return V2HorizontalPodAutoscalerSpec(
                behavior = openapi_client.models.v2/horizontal_pod_autoscaler_behavior.v2.HorizontalPodAutoscalerBehavior(
                    scale_down = openapi_client.models.scale_down.scaleDown(), 
                    scale_up = openapi_client.models.scale_up.scaleUp(), ),
                max_replicas = 56,
                metrics = [
                ...
                min_replicas = 56,
                scale_target_ref = openapi_client.models.v2/cross_version_object_reference.v2.CrossVersionObjectReference(
                    api_version = '', 
                    kind = '', 
                    name = '', )
            )
