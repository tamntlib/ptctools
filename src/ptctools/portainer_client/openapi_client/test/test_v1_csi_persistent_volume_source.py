    ...
    def make_instance(self, include_optional) -> V1CSIPersistentVolumeSource:
        ...
        if include_optional:
            return V1CSIPersistentVolumeSource(
                controller_expand_secret_ref = openapi_client.models.v1/secret_reference.v1.SecretReference(
                    name = '', 
                    namespace = '', ),
                controller_publish_secret_ref = openapi_client.models.v1/secret_reference.v1.SecretReference(
                    name = '', 
                    namespace = '', ),
                driver = '',
                fs_type = '',
                node_expand_secret_ref = openapi_client.models.v1/secret_reference.v1.SecretReference(
                    name = '', 
                    namespace = '', ),
                node_publish_secret_ref = openapi_client.models.v1/secret_reference.v1.SecretReference(
                    name = '', 
                    namespace = '', ),
                node_stage_secret_ref = openapi_client.models.v1/secret_reference.v1.SecretReference(
                    name = '', 
                    namespace = '', ),
                read_only = True,
                volume_attributes = {
