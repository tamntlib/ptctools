...
class TemplatesApi:
    ...
    def template_file(
        ...
        _param = self._template_file_serialize(
            id=id,
    ...
    @validate_call
    def template_file_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Template identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TemplatesFileResponse]:
        """Get a template's file
    ...
    @validate_call
    def template_file_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Template identifier")],
        _request_timeout: Union[
            None,
