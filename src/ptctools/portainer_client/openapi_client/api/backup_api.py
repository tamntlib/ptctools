...
class BackupApi:
    ...
    def backup(
        self,
        body: Annotated[Optional[BackupBackupPayload], Field(description="An object contains the password to encrypt the backup with")] = None,
        ...
        :param body: An object contains the password to encrypt the backup with
        :type body: BackupBackupPayload
    ...
    def restore(
        self,
        restore_payload: Annotated[BackupRestorePayload, Field(description="Restore request payload")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param restore_payload: Restore request payload (required)
        :type restore_payload: BackupRestorePayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
