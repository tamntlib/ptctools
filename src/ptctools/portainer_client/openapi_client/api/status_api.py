...
class StatusApi:
    ...
    def status_inspect(
        ...
        """(Deprecated) Check Portainer status
        ...
        _param = self._status_inspect_serialize(
    ...
    @validate_call
    def status_inspect_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def status_inspect_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
