...
class V1PortStatus(BaseModel):
    ...
    port: Optional[StrictInt] = Field(default=None, description="Port is the port number of the service port of which status is recorded here")
    protocol: Optional[V1Protocol] = Field(default=None, description="Protocol is the protocol of the service port of which status is recorded here The supported values are: \"TCP\", \"UDP\", \"SCTP\"")
