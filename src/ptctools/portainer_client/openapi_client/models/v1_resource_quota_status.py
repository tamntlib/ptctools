...
class V1ResourceQuotaStatus(BaseModel):
    ...
    """ # noqa: E501
    hard: Optional[Dict[str, ResourceQuantity]] = Field(default=None, description="Hard is the set of enforced hard limits for each named resource. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/ +optional")
    used: Optional[Dict[str, ResourceQuantity]] = Field(default=None, description="Used is the current observed total usage of the resource in the namespace. +optional")
