...
class PortainerUserThemeSettings(BaseModel):
    """
    PortainerUserThemeSettings
    """ # noqa: E501
    color: Optional[StrictStr] = Field(default=None, description="Color represents the color theme of the UI")
    ...
    def color_validate_enum(cls, value):
        ...
        if value not in set(['dark', 'light', 'highcontrast', 'auto', '']):
            raise ValueError("must be one of enum values ('dark', 'light', 'highcontrast', 'auto', '')")
        return value
