...
class PortainerStackOption(BaseModel):
    """
    PortainerStackOption
    """ # noqa: E501
    prune: Optional[StrictBool] = Field(default=None, description="Prune services that are no longer referenced")
    __properties: ClassVar[List[str]] = ["prune"]
