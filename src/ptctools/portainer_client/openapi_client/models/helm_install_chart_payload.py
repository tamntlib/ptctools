...
class HelmInstallChartPayload(BaseModel):
    """
    HelmInstallChartPayload
    """ # noqa: E501
    atomic: Optional[StrictBool] = None
    chart: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    namespace: Optional[StrictStr] = None
    repo: Optional[StrictStr] = None
    values: Optional[StrictStr] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["atomic", "chart", "name", "namespace", "repo", "values", "version"]
