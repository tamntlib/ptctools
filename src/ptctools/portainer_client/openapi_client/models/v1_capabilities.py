...
class V1Capabilities(BaseModel):
    ...
    V1Capabilities
    """ # noqa: E501
    add: Optional[List[StrictStr]] = Field(default=None, description="Added capabilities +optional +listType=atomic")
    drop: Optional[List[StrictStr]] = Field(default=None, description="Removed capabilities +optional +listType=atomic")
