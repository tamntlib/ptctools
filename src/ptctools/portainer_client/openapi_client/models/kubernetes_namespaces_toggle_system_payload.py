...
class KubernetesNamespacesToggleSystemPayload(BaseModel):
    """
    KubernetesNamespacesToggleSystemPayload
    """ # noqa: E501
    system: Optional[StrictBool] = Field(default=None, description="Toggle the system state of this namespace to true or false")
