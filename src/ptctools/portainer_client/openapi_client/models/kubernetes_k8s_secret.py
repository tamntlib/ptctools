...
class KubernetesK8sSecret(BaseModel):
    """
    KubernetesK8sSecret
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["Annotations", "ConfigurationOwner", "ConfigurationOwnerId", "ConfigurationOwners", "CreationDate", "Data", "IsUsed", "Labels", "Name", "Namespace", "SecretType", "UID"]
