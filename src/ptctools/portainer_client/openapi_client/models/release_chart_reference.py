...
class ReleaseChartReference(BaseModel):
    """
    ReleaseChartReference
    """ # noqa: E501
    chart_path: Optional[StrictStr] = Field(default=None, alias="chartPath")
    ...
    __properties: ClassVar[List[str]] = ["chartPath", "registryID", "repoURL"]
