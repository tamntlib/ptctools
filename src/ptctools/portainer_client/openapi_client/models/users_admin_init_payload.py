...
class UsersAdminInitPayload(BaseModel):
    """
    UsersAdminInitPayload
    """ # noqa: E501
    password: StrictStr = Field(description="Password for the admin user")
    username: StrictStr = Field(description="Username for the admin user")
