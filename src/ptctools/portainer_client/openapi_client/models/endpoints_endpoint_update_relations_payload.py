...
class EndpointsEndpointUpdateRelationsPayload(BaseModel):
    """
    EndpointsEndpointUpdateRelationsPayload
    """ # noqa: E501
    relations: Optional[Dict[str, EndpointsEndpointUpdateRelationsPayloadRelationsValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "relations": dict(
                (_k, EndpointsEndpointUpdateRelationsPayloadRelationsValue.from_dict(_v))
