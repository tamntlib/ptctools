...
class KubernetesIngressRule(BaseModel):
    """
    ...
    tls: Optional[List[KubernetesTLSInfo]] = Field(default=None, alias="TLS")
    __properties: ClassVar[List[str]] = ["Host", "IP", "Path", "TLS"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "IP": obj.get("IP"),
            "Path": obj.get("Path"),
            "TLS": [KubernetesTLSInfo.from_dict(_item) for _item in obj["TLS"]] if obj.get("TLS") is not None else None
        })
        return _obj
