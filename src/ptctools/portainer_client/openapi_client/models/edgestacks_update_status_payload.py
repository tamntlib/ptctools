...
class EdgestacksUpdateStatusPayload(BaseModel):
    """
    EdgestacksUpdateStatusPayload
    """ # noqa: E501
    endpoint_id: Optional[StrictInt] = Field(default=None, alias="endpointID")
    error: Optional[StrictStr] = None
    status: Optional[PortainerEdgeStackStatusType] = None
    time: Optional[StrictInt] = None
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["endpointID", "error", "status", "time", "version"]
