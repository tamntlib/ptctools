...
class TeamsTeamCreatePayload(BaseModel):
    """
    TeamsTeamCreatePayload
    """ # noqa: E501
    name: StrictStr = Field(description="Name")
    team_leaders: Optional[List[StrictInt]] = Field(default=None, description="TeamLeaders", alias="teamLeaders")
    __properties: ClassVar[List[str]] = ["name", "teamLeaders"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "teamLeaders": obj.get("teamLeaders")
        })
        return _obj
