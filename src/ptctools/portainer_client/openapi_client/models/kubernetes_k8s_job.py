...
class KubernetesK8sJob(BaseModel):
    """
    KubernetesK8sJob
    """ # noqa: E501
    backoff_limit: Optional[StrictInt] = Field(default=None, alias="BackoffLimit")
    command: Optional[StrictStr] = Field(default=None, alias="Command")
    completions: Optional[StrictInt] = Field(default=None, alias="Completions")
    container: Optional[V1Container] = Field(default=None, alias="Container")
    ...
    __properties: ClassVar[List[str]] = ["BackoffLimit", "Command", "Completions", "Container", "Duration", "FailedReason", "FinishTime", "Id", "IsSystem", "Name", "Namespace", "PodName", "StartTime", "Status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Container": V1Container.from_dict(obj["Container"]) if obj.get("Container") is not None else None,
