...
class PortainerKubernetesData(BaseModel):
    """
    PortainerKubernetesData
    """ # noqa: E501
    configuration: Optional[PortainerKubernetesConfiguration] = Field(default=None, alias="Configuration")
    flags: Optional[PortainerKubernetesFlags] = Field(default=None, alias="Flags")
    snapshots: Optional[List[PortainerKubernetesSnapshot]] = Field(default=None, alias="Snapshots")
    __properties: ClassVar[List[str]] = ["Configuration", "Flags", "Snapshots"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Configuration": PortainerKubernetesConfiguration.from_dict(obj["Configuration"]) if obj.get("Configuration") is not None else None,
            "Flags": PortainerKubernetesFlags.from_dict(obj["Flags"]) if obj.get("Flags") is not None else None,
            "Snapshots": [PortainerKubernetesSnapshot.from_dict(_item) for _item in obj["Snapshots"]] if obj.get("Snapshots") is not None else None
        })
        return _obj
