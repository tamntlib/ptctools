...
class DockerDashboardResponse(BaseModel):
    ...
    """ # noqa: E501
    containers: Optional[DockerContainerStats] = None
    images: Optional[DockerImagesCounters] = None
    networks: Optional[StrictInt] = None
    services: Optional[StrictInt] = None
    stacks: Optional[StrictInt] = None
    volumes: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["containers", "images", "networks", "services", "stacks", "volumes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "containers": DockerContainerStats.from_dict(obj["containers"]) if obj.get("containers") is not None else None,
            "images": DockerImagesCounters.from_dict(obj["images"]) if obj.get("images") is not None else None,
