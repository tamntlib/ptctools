...
class EndpointsEndpointDeleteBatchPartialResponse(BaseModel):
    """
    EndpointsEndpointDeleteBatchPartialResponse
    """ # noqa: E501
    deleted: Optional[List[StrictInt]] = None
    errors: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["deleted", "errors"]
