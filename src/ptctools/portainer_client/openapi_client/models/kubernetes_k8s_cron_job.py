...
class KubernetesK8sCronJob(BaseModel):
    """
    ...
    jobs: Optional[List[KubernetesK8sJob]] = Field(default=None, alias="Jobs")
    ...
    suspend: Optional[StrictBool] = Field(default=None, alias="Suspend")
    timezone: Optional[StrictStr] = Field(default=None, alias="Timezone")
    __properties: ClassVar[List[str]] = ["Command", "Id", "IsSystem", "Jobs", "Name", "Namespace", "Schedule", "Suspend", "Timezone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Jobs": [KubernetesK8sJob.from_dict(_item) for _item in obj["Jobs"]] if obj.get("Jobs") is not None else None,
            "Name": obj.get("Name"),
