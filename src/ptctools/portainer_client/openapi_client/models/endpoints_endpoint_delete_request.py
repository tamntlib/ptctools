...
class EndpointsEndpointDeleteRequest(BaseModel):
    """
    EndpointsEndpointDeleteRequest
    """ # noqa: E501
    delete_cluster: Optional[StrictBool] = Field(default=None, alias="deleteCluster")
    id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["deleteCluster", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deleteCluster": obj.get("deleteCluster"),
            "id": obj.get("id")
        })
        return _obj
