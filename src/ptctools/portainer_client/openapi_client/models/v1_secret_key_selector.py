...
class V1SecretKeySelector(BaseModel):
    ...
    V1SecretKeySelector
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The key of the secret to select from.  Must be a valid secret key.")
    ...
    optional: Optional[StrictBool] = Field(default=None, description="Specify whether the Secret or its key must be defined +optional")
