...
class KubernetesK8sPersistentVolume(BaseModel):
    """
    ...
    capacity: Optional[Dict[str, ResourceQuantity]] = None
    claim_ref: Optional[V1ObjectReference] = Field(default=None, alias="claimRef")
    csi: Optional[V1CSIPersistentVolumeSource] = None
    name: Optional[StrictStr] = None
    persistent_volume_reclaim_policy: Optional[V1PersistentVolumeReclaimPolicy] = Field(default=None, alias="persistentVolumeReclaimPolicy")
    ...
    __properties: ClassVar[List[str]] = ["accessModes", "annotations", "capacity", "claimRef", "csi", "name", "persistentVolumeReclaimPolicy", "storageClassName", "volumeMode"]
