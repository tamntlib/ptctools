...
class UsersUserUpdatePayload(BaseModel):
    """
    UsersUserUpdatePayload
    """ # noqa: E501
    new_password: StrictStr = Field(alias="newPassword")
    password: StrictStr
    role: StrictInt = Field(description="User role (1 for administrator account and 2 for regular account)")
    theme: Optional[UsersThemePayload] = None
    use_cache: StrictBool = Field(alias="useCache")
    username: StrictStr
    __properties: ClassVar[List[str]] = ["newPassword", "password", "role", "theme", "useCache", "username"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "theme": UsersThemePayload.from_dict(obj["theme"]) if obj.get("theme") is not None else None,
