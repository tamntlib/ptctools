...
class KubernetesK8sIngressInfo(BaseModel):
    """
    ...
    hosts: Optional[List[StrictStr]] = Field(default=None, alias="Hosts")
    ...
    paths: Optional[List[KubernetesK8sIngressPath]] = Field(default=None, alias="Paths")
    tls: Optional[List[KubernetesK8sIngressTLS]] = Field(default=None, alias="TLS")
    type: Optional[StrictStr] = Field(default=None, alias="Type")
    uid: Optional[StrictStr] = Field(default=None, alias="UID")
    __properties: ClassVar[List[str]] = ["Annotations", "ClassName", "CreationDate", "Hosts", "Labels", "Name", "Namespace", "Paths", "TLS", "Type", "UID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Paths": [KubernetesK8sIngressPath.from_dict(_item) for _item in obj["Paths"]] if obj.get("Paths") is not None else None,
            "TLS": [KubernetesK8sIngressTLS.from_dict(_item) for _item in obj["TLS"]] if obj.get("TLS") is not None else None,
            "Type": obj.get("Type"),
            "UID": obj.get("UID")
        })
        return _obj
