...
class UsersAccessTokenResponse(BaseModel):
    """
    UsersAccessTokenResponse
    """ # noqa: E501
    api_key: Optional[PortainerAPIKey] = Field(default=None, alias="apiKey")
    raw_api_key: Optional[StrictStr] = Field(default=None, alias="rawAPIKey")
    __properties: ClassVar[List[str]] = ["apiKey", "rawAPIKey"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apiKey": PortainerAPIKey.from_dict(obj["apiKey"]) if obj.get("apiKey") is not None else None,
