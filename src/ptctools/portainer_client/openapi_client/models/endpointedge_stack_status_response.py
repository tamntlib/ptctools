...
class EndpointedgeStackStatusResponse(BaseModel):
    """
    EndpointedgeStackStatusResponse
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="EdgeStack Identifier")
    version: Optional[StrictInt] = Field(default=None, description="Version of this stack")
