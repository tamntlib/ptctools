...
class KubernetesK8sServicePort(BaseModel):
    """
    KubernetesK8sServicePort
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    node_port: Optional[StrictInt] = Field(default=None, alias="NodePort")
    ...
    __properties: ClassVar[List[str]] = ["Name", "NodePort", "Port", "Protocol", "TargetPort"]
