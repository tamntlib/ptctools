...
class KubernetesK8sIngressPath(BaseModel):
    """
    KubernetesK8sIngressPath
    """ # noqa: E501
    has_service: Optional[StrictBool] = Field(default=None, alias="HasService")
    host: Optional[StrictStr] = Field(default=None, alias="Host")
    ingress_name: Optional[StrictStr] = Field(default=None, alias="IngressName")
    ...
    __properties: ClassVar[List[str]] = ["HasService", "Host", "IngressName", "Path", "PathType", "Port", "ServiceName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "HasService": obj.get("HasService"),
            "Host": obj.get("Host"),
            "IngressName": obj.get("IngressName"),
            "Path": obj.get("Path"),
