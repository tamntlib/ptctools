...
class V1TCPSocketAction(BaseModel):
    ...
    V1TCPSocketAction
    """ # noqa: E501
    host: Optional[StrictStr] = Field(default=None, description="Optional: Host name to connect to, defaults to the pod IP. +optional")
    port: Optional[IntstrIntOrString] = Field(default=None, description="Number or name of the port to access on the container. Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME.")
