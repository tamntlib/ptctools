...
class KubernetesK8sNamespaceDetails(BaseModel):
    """
    ...
    resource_quota: Optional[KubernetesK8sResourceQuota] = Field(default=None, alias="ResourceQuota")
    __properties: ClassVar[List[str]] = ["Annotations", "Name", "Owner", "ResourceQuota"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Name": obj.get("Name"),
            "Owner": obj.get("Owner"),
            "ResourceQuota": KubernetesK8sResourceQuota.from_dict(obj["ResourceQuota"]) if obj.get("ResourceQuota") is not None else None
        })
        return _obj
