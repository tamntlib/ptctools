...
class PortainerKubernetesSnapshot(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["DiagnosticsData", "KubernetesVersion", "NodeCount", "PerformanceMetrics", "Time", "TotalCPU", "TotalMemory"]
