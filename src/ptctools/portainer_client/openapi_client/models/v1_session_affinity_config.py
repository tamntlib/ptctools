...
class V1SessionAffinityConfig(BaseModel):
    ...
    """ # noqa: E501
    client_ip: Optional[V1ClientIPConfig] = Field(default=None, description="clientIP contains the configurations of Client IP based session affinity. +optional", alias="clientIP")
