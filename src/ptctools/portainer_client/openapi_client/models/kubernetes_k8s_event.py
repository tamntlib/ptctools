...
class KubernetesK8sEvent(BaseModel):
    """
    KubernetesK8sEvent
    """ # noqa: E501
    count: Optional[StrictInt] = None
    event_time: Optional[StrictStr] = Field(default=None, alias="eventTime")
    first_timestamp: Optional[StrictStr] = Field(default=None, alias="firstTimestamp")
    involved_object: Optional[KubernetesK8sEventInvolvedObject] = Field(default=None, alias="involvedObject")
    kind: Optional[StrictStr] = None
    last_timestamp: Optional[StrictStr] = Field(default=None, alias="lastTimestamp")
    ...
    __properties: ClassVar[List[str]] = ["count", "eventTime", "firstTimestamp", "involvedObject", "kind", "lastTimestamp", "message", "name", "namespace", "reason", "type", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "involvedObject": KubernetesK8sEventInvolvedObject.from_dict(obj["involvedObject"]) if obj.get("involvedObject") is not None else None,
            "kind": obj.get("kind"),
