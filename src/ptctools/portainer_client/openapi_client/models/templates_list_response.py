...
class TemplatesListResponse(BaseModel):
    ...
    """ # noqa: E501
    templates: Optional[List[PortainerTemplate]] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["templates", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "templates": [PortainerTemplate.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None,
