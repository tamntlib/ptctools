...
class EdgejobsEdgeJobCreateFromFileContentPayload(BaseModel):
    """
    ...
    endpoints: Optional[List[StrictInt]] = None
    file_content: Optional[StrictStr] = Field(default=None, alias="fileContent")
    name: Optional[StrictStr] = None
    recurring: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["cronExpression", "edgeGroups", "endpoints", "fileContent", "name", "recurring"]
