...
class V1ScopeSelector(BaseModel):
    ...
    V1ScopeSelector
    """ # noqa: E501
    match_expressions: Optional[List[V1ScopedResourceSelectorRequirement]] = Field(default=None, description="A list of scope selector requirements by scope of the resources. +optional +listType=atomic", alias="matchExpressions")
