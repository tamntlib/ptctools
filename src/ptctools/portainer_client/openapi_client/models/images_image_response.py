...
class ImagesImageResponse(BaseModel):
    """
    ImagesImageResponse
    """ # noqa: E501
    ...
    used: Optional[StrictBool] = Field(default=None, description="Used is true if the image is used by at least one container supplied only when withUsage is true")
    __properties: ClassVar[List[str]] = ["created", "id", "nodeName", "size", "tags", "used"]
