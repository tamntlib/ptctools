...
class WebhooksWebhookCreatePayload(BaseModel):
    """
    ...
    webhook_type: Optional[PortainerWebhookType] = Field(default=None, description="Type of webhook (1 - service)", alias="webhookType")
    __properties: ClassVar[List[str]] = ["endpointID", "registryID", "resourceID", "webhookType"]
