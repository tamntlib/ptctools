...
class V2ObjectMetricStatus(BaseModel):
    ...
    """ # noqa: E501
    current: Optional[V2MetricValueStatus] = Field(default=None, description="current contains the current value for the given metric")
    described_object: Optional[V2CrossVersionObjectReference] = Field(default=None, description="DescribedObject specifies the descriptions of a object,such as kind,name apiVersion", alias="describedObject")
    metric: Optional[V2MetricIdentifier] = Field(default=None, description="metric identifies the target metric by name and selector")
