...
class PortainerKubernetesIngressClassConfig(BaseModel):
    """
    PortainerKubernetesIngressClassConfig
    """ # noqa: E501
    blocked: Optional[StrictBool] = Field(default=None, alias="Blocked")
    blocked_namespaces: Optional[List[StrictStr]] = Field(default=None, alias="BlockedNamespaces")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    type: Optional[StrictStr] = Field(default=None, alias="Type")
    __properties: ClassVar[List[str]] = ["Blocked", "BlockedNamespaces", "Name", "Type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "BlockedNamespaces": obj.get("BlockedNamespaces"),
            "Name": obj.get("Name"),
            "Type": obj.get("Type")
        })
        return _obj
