...
class UnstructuredUnstructured(BaseModel):
    """
    UnstructuredUnstructured
    """ # noqa: E501
    object: Optional[Dict[str, Any]] = Field(default=None, description="Object is a JSON compatible map with string, float, int, bool, []interface{}, or map[string]interface{} children.")
