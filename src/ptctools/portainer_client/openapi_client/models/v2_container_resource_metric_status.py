...
class V2ContainerResourceMetricStatus(BaseModel):
    ...
    """ # noqa: E501
    container: Optional[StrictStr] = Field(default=None, description="container is the name of the container in the pods of the scaling target")
    ...
    name: Optional[V1ResourceName] = Field(default=None, description="name is the name of the resource in question.")
