...
class V1EnvVar(BaseModel):
    ...
    V1EnvVar
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the environment variable. Must be a C_IDENTIFIER.")
    ...
    value_from: Optional[V1EnvVarSource] = Field(default=None, description="Source for the environment variable's value. Cannot be used if value is not empty. +optional", alias="valueFrom")
